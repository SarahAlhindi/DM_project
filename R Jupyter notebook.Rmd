...
While working on this project, we have prepared the data to actually implement data mining techniques on it, i.e: classification and clustering. As discussed in the previous section, for classification, using K-fold Cross-validation to partition the data, gain ratio with k=10 showcased the most effective performance for our dataset based on Accuracy, Precision, Sensitivity and Specificity metrics.
